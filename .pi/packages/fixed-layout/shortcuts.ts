// Adapted from pi-powerline-footer's MIT-licensed shortcut matching:
...
export function matchesStashShortcutInput(
  data: string,
  options: { includePrintableSharpS?: boolean } = {},
): boolean {
  if (isKeyRelease(data)) return false;

  return (
    (options.includePrintableSharpS === true && data === "ß") ||
    data === "\x1bs" ||
    data === "\x1bS" ||
